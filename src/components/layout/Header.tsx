  ...
  return (
    <header className="fixed top-0 inset-x-0 z-50 bg-white/80 backdrop-blur-xl border-b border-neutral-100 p-6 flex justify-between items-center px-6 md:px-12 w-full">
      <div className="flex items-center gap-6 md:gap-12">
        <a href="/sarapul-portal/" className="font-bold text-2xl tracking-tighter hover:opacity-80 transition">
          САРАПУЛ<span className="text-orange-600">.</span>
        </a>
        <nav className="hidden md:flex gap-6 text-sm font-medium text-neutral-600">
          <a href="/sarapul-portal/city" className="hover:text-black transition-colors">О городе</a>
          <a href="/sarapul-portal/business" className="hover:text-black transition-colors">Бизнес и ТОР</a>
          <a href="/sarapul-portal/culture" className="hover:text-black transition-colors">Культура</a>
          <a href="/sarapul-portal/tourism" className="hover:text-black transition-colors">Туризм</a>
        </nav>
      </div>
